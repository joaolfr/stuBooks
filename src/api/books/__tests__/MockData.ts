  ...
  items: [
    {
      ...
      volumeInfo: {
        ...
        language: 'en',
        previewLink:
          'http://books.google.com.br/books?id=KOXPEAAAQBAJ&printsec=frontcover&dq=isbn:9781633439290&hl=&cd=1&source=gbs_api',
        infoLink:
          'http://books.google.com.br/books?id=KOXPEAAAQBAJ&dq=isbn:9781633439290&hl=&source=gbs_api',
        canonicalVolumeLink:
      ...
      searchInfo: {
        textSnippet:
          'The book teaches you how React thinks, introducing ways of structuring your architecture that even work with large teams. React Quickly, Second Edition is a practical guide to React for busy web developers.',
      },
    },
  ],
}
